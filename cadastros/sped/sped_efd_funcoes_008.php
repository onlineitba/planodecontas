...
function sped_efd_registro_0400() {
                ...
                $filtromodelo="and modelo<>'03' and modelo<>'08' and modelo<>'21' and modelo<>'22' and modelo<>'57'";
			...
			$tot_registro_bloco_H010=0;
					...
					$qtd=number_format($qtd, 2, ",", "");
					  ...
					  $vl_item=$vl_unit*$v[sqtotal];
			               ...
			               $linha= "|H010|".$cod_item."|".$unid."|".$qtd."|".$vl_unit."|".$vl_item."|".$ind_prop."|".$cod_part."|".$txt_compl."|".$cod_cta."|";
